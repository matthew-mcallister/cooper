impl_enums! {
    ...
    Value AccessQualifier {
        ReadOnly = 0,
        WriteOnly = 1,
        ReadWrite = 2,
    }
    Value FunctionParameterAttribute {
        Zext = 0,
        Sext = 1,
        ByVal = 2,
        Sret = 3,
    ...
    Value KernelEnqueueFlags {
        NoWait = 0,
        WaitKernel = 1,
        WaitWorkGroup = 2,
    }
    Bit KernelProfilingInfo {
        CmdExecTime = 0,
    }
    Value Capability {
        Matrix = 0,
    ...
    Value Op {
        ...
        +DecorateStringGOOGLE = DecorateString,
        +MemberDecorateStringGOOGLE = MemberDecorateString,
    }
}
